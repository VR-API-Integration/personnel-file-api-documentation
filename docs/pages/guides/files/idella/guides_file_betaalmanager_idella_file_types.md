...
permalink: guides_file_betaalmanager_idella_file_types.html
folder: guides/files/idella
topnav: topnav
---

## Betaalmanager Exports - PB&Core 

| Owner           | Type   | Business TypeId | Business Type Name                 | File Patterns          |
| --------------- | ------ | --------------- | ---------------------------------- | ---------------------- |
| Betaalmanager   | Export | 114000          | RBM PB&Core Downloads              | *_SEPA.csv             |
| Betaalmanager   | Export | 114001          | RBM PB&Core Payment Files          | *_SEPA.xml, *_SEPA.zip |
